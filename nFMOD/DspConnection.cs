...
namespace nFMOD
{
    ...
    {
        #region Externs
        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_GetInput"), SuppressUnmanagedCodeSecurity]
        private static extern ErrorCode GetInput (IntPtr dspconnection, ref IntPtr input);

        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_GetLevels"), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_GetMemoryInfo"), SuppressUnmanagedCodeSecurity]
        ...
        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_GetMix"), SuppressUnmanagedCodeSecurity]
        private static extern ErrorCode GetMix(IntPtr dspconnection, ref float volume);

        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_GetOutput"), SuppressUnmanagedCodeSecurity]
        private static extern ErrorCode GetOutput (IntPtr dspconnection, ref IntPtr output);

        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_GetUserData"), SuppressUnmanagedCodeSecurity]
        private static extern ErrorCode GetUserData (IntPtr dspconnection, ref IntPtr userdata);

        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_SetLevels"), SuppressUnmanagedCodeSecurity]
        private static extern ErrorCode SetLevels (IntPtr dspconnection, Speaker speaker, float[] levels, int numlevels);

        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_SetMix"), SuppressUnmanagedCodeSecurity]
        private static extern ErrorCode SetMix(IntPtr dspconnection, float volume);

        [DllImport(Common.FMOD_DLL_NAME, EntryPoint = "FMOD_DSPConnection_SetUserData"), SuppressUnmanagedCodeSecurity]
