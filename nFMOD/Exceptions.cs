...
namespace nFMOD
{
    public class FmodException : Exception
    {
        ...
        public override string Message
        {
            get
            {
                return "Unknown FMOD error occurred; error code: " + _errorCode + ".";
            }
        }
    }
    ...
    public class FmodDspConnectionException : FmodException
    {
        public override string Message
        {
            get
            {
                return "DSP connection error.  DspConnection possibly caused a cyclic dependancy.  Or tried to connect a tree too many units deep (more than 128).";
            }
        }
    }
    ...
    public class FmodMemoryIopException : FmodException
    {
        public override string Message
        {
            get
            {
                return "Not enough memory or resources on PlayStation 2 IOP ram.";
            }
        }
    }
    ...
    public class FmodIrxException : FmodException
    {
        public override string Message
        {
            get
            {
                return "fmodex.irx failed to initialize. This is most likely because you forgot to load it.";
            }
        }
    }
    #endregion
